...
"Book Store" is a website to see Books. It is a Single Page App (SPA) that allows users to:
...
```sh
  cd my-folder
  git clone https://github.com/Rana-Mudassir/bookstore-react
```
### Install
...
Feel free to check the [issues page](https://github.com/Rana-Mudassir/bookstore-react/issues).
